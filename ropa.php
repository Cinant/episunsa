...
<div id="cont2">
      ...
      $consulta="SELECT  imagen_id,marca,precio,descripcion  from imagenes5 where categoria='Ropa'";
      $result=@mysql_query($consulta) or die(mysql_error());
 
      $consulta2="SELECT  count(imagen_id) as cuenta from imagenes5 where categoria='Ropa'";
