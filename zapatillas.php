...
<TITLE>MANTRA SKATE SHOP</TITLE>
<link rel="shortcut icon" href="img/12.PNG">
<script>
...
<body>
 ...
 <li><a href="#" title="1" id="title1">CATEGORÍAS</a></li>
  ...
  <li><a href="chocolate.php" title="">CHOCOLATE</a></li>
      ...
      $consulta="SELECT  imagen_id,marca,precio_venta,descripcion  from prod_img where categoria='zapatillas'";
      $result=@mysql_query($consulta) or die(mysql_error());
     
      $consulta2="SELECT  count(imagen_id) as cuenta from prod_img where categoria='zapatillas'";
      ...
      while ($reg=mysql_fetch_assoc($result)) {
        //echo "cantidad de datos :".$valor;
       // echo "ID numero : ".$reg["imagen_id"];
