...
<body>
  ...
  <ul id="menu">
    ...
    <a href="#">INICIO</a>
    <ul>
      <li onclick="elegir()"><a href="tablas.php">TABLAS</a></li>
      <li onclick="elegir()"> <a href="trucks.php">TRUCKS</a></li>
      <li onclick="elegir()"><a href="ruedas.php">RUEDAS</a></li>
      <li onclick="elegir()"><a href="zapatillas.php">ZAPATILLAS</a></li>
      <li onclick="elegir()"><a href="hardware.php">HARDWARE</a></li>
	...
	<div class="container">
    	<div id="slides">
			     <img src="img/patinetas1.jpg" >
      		<img src="img/zapa1.jpg" >
      		<img src="img/skate1.jpg" >
     		<a href="#" class="slidesjs-previous slidesjs-navigation"><i class="icon-chevron-left"></i></a>
    		<a href="#" class="slidesjs-next slidesjs-navigation"><i class="icon-chevron-right"></i></a>
    	</div>
    <div id="imagenderecha" style="height:500px"><img src="img/Skate-Accessories.png"></div>
    <div id="imagenizq"><img src="img/zapa1.jpg"></div>  
    </div>
 ...
 <li><a href="#" title="1" id="title1">CATEGORÍAS</a></li>
  ...
  <div id="cont1">
      ...
      $consulta="SELECT  imagen_id,marca,precio_venta,descripcion  from prod_img ";
      $result=@mysql_query($consulta) or die(mysql_error());
      
      $consulta2="SELECT  count(imagen_id) as cuenta from prod_img ";
      ...
      echo '<td><img class="hola" src="mostrarimg.php?id='.$reg["imagen_id"].'"/><p>'.$reg["marca"].'-'.$reg["descripcion"].'<br>Precio de venta: S/.'.$reg["precio_venta"].'</p></td>';
         $hola++;
