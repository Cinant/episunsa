 ...
 <li><a href="#" title="1" id="title1">CATEGORÍAS</a></li>
  ...
  <li><a href="chocolate.php" title="">CHOCOLATE</a></li>
    ...
    <div id="cont1">
      ...
      $consulta="SELECT  imagen_id,marca,precio_venta,descripcion  from prod_img where categoria='Tablas'";
      $result=@mysql_query($consulta) or die(mysql_error());
      
      $consulta2="SELECT  count(imagen_id) as cuenta from prod_img where categoria='Tablas'";
