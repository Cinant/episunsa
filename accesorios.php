...
<<div id="cont2">
     <?php
      ...
      $consulta="SELECT  imagen_id,marca,precio,descripcion  from imagenes5 where categoria='Accesorios'";
      $result=@mysql_query($consulta) or die(mysql_error());
      
      $consulta2="SELECT  count(imagen_id) as cuenta from imagenes5 where categoria='Accesorios'";
